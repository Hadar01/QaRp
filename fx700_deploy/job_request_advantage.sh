#!/bin/bash
#SBATCH --job-name=qsc_request_advantage
#SBATCH -N 1
#SBATCH -p Batch
#SBATCH --time=00:30:00
#SBATCH --output=results/qsc_request_advantage-%j.log
#SBATCH --error=results/qsc_request_advantage-%j.err
...
echo "Starting QSC2025 optimization: request_advantage.json"
...
python -u run_optimization.py \
    ...
    --backend qulacs \
    --output results/request_advantage_result.json \
    --shots 10000 \
    --max_iter 500
